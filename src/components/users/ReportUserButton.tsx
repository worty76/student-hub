...
import { ReportUserRequest, ReportUserError, USER_REPORT_REASONS } from '@/types/auth';
import { 
  Loader2, 
  Flag, 
  AlertTriangle,
...
export default function ReportUserButton({
  ...
  const handleReportClick = () => {
    if (!isAuthenticated) {
      toast({
        ...
        description: "Xin hãy đăng nhập để báo cáo người dùng"
      });
  ...
  const handleConfirmReport = async () => {
    ...
    try {
      ...
      const response = await UserService.reportUser(userId, token, reportData);
      ...
      if (error && typeof error === 'object' && 'code' in error) {
        const reportError = error as ReportUserError;
        ...
        switch (reportError.code) {
          ...
          case 404:
            toast({
              ...
              description: "Người dùng bạn đang cố báo cáo không còn tồn tại"
            });
            break;
          default:
            toast({
        ...
        toast({
          variant: "destructive",
          title: "Báo cáo thất bại",
          description: error.message || "Đã xảy ra lỗi không xác định. Xin hãy thử lại."
        });
      } else {
        toast({
          variant: "destructive",
        ...
        {reportSuccess ? (
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Báo cáo người dùng này nếu bạn thấy có hành vi không phù hợp. Chúng tôi sẽ xem xét và xử lý kịp thời.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    {USER_REPORT_REASONS.map((reasonOption) => (
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="description"
                  placeholder="Vui lòng mô tả chi tiết hành vi không phù hợp của người dùng này..."
                  value={description}
                  onChange={(e) => {
