        ...
        <DialogContent className="sm:max-w-[520px] bg-gradient-to-br from-white to-blue-50 border-0 shadow-2xl">
          <DialogHeader className="pb-6">
            ...
            <DialogDescription className="text-gray-600 text-base leading-relaxed">
              Hoàn thành thông tin dưới đây để tiến hành thanh toán an toàn qua VNPAY.
            </DialogDescription>
          </DialogHeader>
          ...
          {product && (
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <h3 className="font-semibold text-lg text-gray-800 leading-tight">{product.title}</h3>
                    </div>
                  </div>
                  
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-1">
                      <span className="text-gray-500 text-sm font-medium">Giá thanh toán</span>
                        <p className="font-bold text-lg">{formatPrice(product.price)}</p>
                    </div>
                    <div className="space-y-1">
                      <span className="text-gray-500 text-sm font-medium">Người bán</span>
              ...
              <div className="space-y-3">
                <Label htmlFor="shippingAddress" className="flex items-center gap-2 text-base font-semibold text-gray-700">
