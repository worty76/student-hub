    ...
    <Card className="shadow-2xl border-0 bg-white/90 backdrop-blur-sm overflow-hidden">
      <div className="bg-gradient-to-r from-green-500 to-emerald-600 py-12 px-6 flex flex-col items-center">
        ...
        <p className="text-white/90 mt-4 text-center text-lg">
          Cảm ơn bạn đã mua sản phẩm. Thanh toán của bạn đã được xử lý thành
          công.
        </p>
      </div>
        ...
        <div className="space-y-8">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">
                    {new Intl.NumberFormat("vi-VN", {
                      style: "currency",
                      currency: "VND",
                    }).format(parseInt(paymentDetails.amount))}
                  </span>
                </div>
              )}
          ...
          <div className="bg-blue-50 rounded-xl p-6">
            ...
            <p className="text-gray-600 mb-4">
              Bạn sẽ nhận được email xác nhận đơn hàng. Người bán sẽ liên hệ với
              bạn để bàn giao sản phẩm.
            </p>
          </div>
